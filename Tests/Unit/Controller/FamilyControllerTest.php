...
/**
 * Test case for class Tx_Timekeeping_Controller_FamilyController.
 *
 * @version $Id$
 ...
 */
class Tx_Timekeeping_Controller_FamilyControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
